...
// LoadModel loads the PCA model JSON (produced by scripts/fit_pca.py) into the
// C++ engine. Must be called once at startup before ProjectToPCA, or every
// projection will report the model as not loaded.
